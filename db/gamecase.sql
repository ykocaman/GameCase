...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `expire_gifts` ON SCHEDULE EVERY 10 MINUTE STARTS '2016-05-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO call expire_gifts()$$
